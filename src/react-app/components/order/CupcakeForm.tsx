    ...
    <form onSubmit={handleSubmit} className="bg-white p-8 md:p-10 border border-light-gray">
      <div className="flex items-center gap-3 mb-8 pb-6 border-b border-light-gray">
        ...
        <div>
          ...
          <p className="text-xs text-gray">Starting at $3/cupcake</p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="pt-4 border-t border-light-gray">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <FormSelect
              ...
              onChange={handleChange}
              options={cupcakeQuantities.map((q) => ({
                value: q.value,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
            <FormSelect
              ...
              onChange={handleChange}
              options={cupcakeFlavors.map((f) => ({ value: f, label: f }))}
              required
            />
            <FormSelect
              label="Frosting Type"
        ...
        <div className="pt-4 border-t border-light-gray">
          ...
          <FormTextarea
            ...
            onChange={handleChange}
            placeholder="Colors, toppers, sprinkles, themes, dietary requirements, etc."
            rows={3}
          />
        </div>
